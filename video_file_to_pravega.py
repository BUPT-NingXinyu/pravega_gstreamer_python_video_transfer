...
def main():
    ...
    parser.add_argument("--pravega-scope", default="nxytest")
    parser.add_argument("--pravega-stream", default="videotest")
    parser.add_argument("--source-uri", required=True,
                        help="URI of the file to import",default="./1.mp4")
    #parser.add_argument("--source-uri", default="/home/yjw/pravega-python-nxy/1.mp4")
    #parser.add_argument("--source-uri", default='/home/yjw/wifi-ble1.mp4')
    ...
    parser.add_argument("--start-utc", default="2021-12-28T23:41:45.691Z",
                        help="The first frame in the video file will be recorded with this timestamp in RFC 3339 format (2021-12-28T23:41:45.691Z).")
